...
pub fn run() {
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::settings_commands::recommend_routing_strategy,
            commands::settings_commands::apply_routing_strategy_template,
            commands::settings_commands::get_project_routing_strategy,
            ...
            commands::dashboard_commands::acknowledge_feedback_event,
            commands::dashboard_commands::resolve_feedback_event,
            commands::dashboard_commands::ignore_feedback_event,
